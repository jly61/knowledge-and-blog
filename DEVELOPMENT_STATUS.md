...
#### 2. Markdown 编辑器增强
- [ ] 实时预览（Tiptap 编辑器，支持编辑/预览/分屏三种模式）
- [ ] 语法高亮（代码块语法高亮）
- [ ] 工具栏（格式化工具栏，支持标题、加粗、斜体、代码块等）
- [ ] 图片上传支持
...
2. **笔记管理**
   ...
   - 基础 Textarea 编辑器（Markdown 编辑器增强功能待实现）
   - 链接预览（悬停显示笔记摘要）
...
### 优先级 3：优化和完善
1. Markdown 编辑器增强（Tiptap 集成、实时预览、语法高亮、工具栏）
2. 图片上传支持
3. 知识图谱布局稳定性优化
4. 搜索功能增强（日期范围、搜索历史）
